         ...
         <div class="app-navbar flex-shrink-0">
            ...
            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
               ...
               <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                  <img src="{{ optional(optional(auth()->user() ?? null)->image)->url() ??asset("assets/media/avatars/300-1.jpg") }}" alt="user" />
               </div>
               ...
               <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                  ...
                  <div class="menu-item px-5">
                     <a href="{{ route('login') }}" class="menu-link px-5">{{ __("board.my_profile") }}</a>
                  </div>
                  ...
                  <div class="menu-item px-3">
                     <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                           <img alt="Logo" src="{{ optional(optional(auth()->user() ?? null)->image)->url() ?? asset("assets/media/avatars/300-1.jpg") }}" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Username-->
                  ...
                  <!--end::Menu separator-->
                   <!--begin::Menu item-->
                   <div class="menu-item px-5">
                     <a href="{{ route('customer.show', auth()->user()->id) }}" class="menu-link px-5">{{ __("board.my_profile") }}</a>
                  </div>
                  <!--end::Menu item-->
                   <!--begin::Menu separator-->
                   <div class="separator my-2"></div>
                   ...
                   <!--begin::Menu item-->
                   <div class="menu-item px-5">
                      <a href="{{ route('logout') }}" onClick="event.preventDefault(); document.getElementById('logout-form').submit();" class="menu-link px-5">{{ __("board.sign_out") }}</a>
